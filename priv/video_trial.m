...
%WARNING: Private, auxiliary file. %Hard-coded parameter limiting the number of groups displayed in trajectories.
...
while count<n,
    if labels(count)==1
        ...
        while (i<=n)&&(labels(i)==1),
            ...
            plot3(x_p,y_p,z_p,'Color','b','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);%b
    ...
    elseif labels(count)==2,
        ...
        while (i<=n)&&(labels(i)==2),
            ...
            if do_record<=0, subplot(2,2,index_plot); end
            plot3(x_p,y_p,z_p,'Color','r','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);%k
            if do_record>0, set(gca,'xlim',[low_lim(1) up_lim(1)+0.2],'ylim',[low_lim(2) up_lim(2)],'zlim',[low_lim(3) up_lim(3)]); end
            pause(pauses(2));
    ...
    elseif (labels(count)==3)&&(n_labels>2),
        ...
        while (i<=n)&&(labels(i)==3),
            ...
            if do_record<=0, subplot(2,2,index_plot); end
            plot3(x_p,y_p,z_p,'Color','g','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);
            if do_record>0, set(gca,'xlim',[low_lim(1) up_lim(1)+0.2],'ylim',[low_lim(2) up_lim(2)],'zlim',[low_lim(3) up_lim(3)]); end
            pause(pauses(3));
    ...
    elseif (labels(count)==4)&&(n_labels>3),
        ...
        while (i<=n)&&(labels(i)==4),
            ...
            if do_record<=0, subplot(2,2,index_plot); end
            plot3(x_p,y_p,z_p,'Color','k','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);
            if do_record>0, set(gca,'xlim',[low_lim(1) up_lim(1)+0.2],'ylim',[low_lim(2) up_lim(2)],'zlim',[low_lim(3) up_lim(3)]); end
            pause(pauses(4));
    ...
    elseif (labels(count)==5)&&(n_labels>4),
        ...
        while (i<=n)&&(labels(i)==5),
            ...
            if do_record<=0, subplot(2,2,index_plot); end
            plot3(x_p,y_p,z_p,'Color','c','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);
            if do_record>0, set(gca,'xlim',[low_lim(1) up_lim(1)+0.2],'ylim',[low_lim(2) up_lim(2)],'zlim',[low_lim(3) up_lim(3)]); end
            pause(pauses(5));
    ...
    elseif (labels(count)==6)&&(n_labels>5),
        ...
        while (i<=n)&&(labels(i)==6),
            ...
            if do_record<=0, subplot(2,2,index_plot); end
            plot3(x_p,y_p,z_p,'Color','m','LineStyle','-','LineWidth',1,'Marker','o','MarkerSize',1.5);
            if do_record>0, set(gca,'xlim',[low_lim(1) up_lim(1)+0.2],'ylim',[low_lim(2) up_lim(2)],'zlim',[low_lim(3) up_lim(3)]); end
            pause(pauses(1));
    ...
    elseif labels(count)==-1
        ...
        while (i<=n)&&(labels(i)==-1),
            ...
            plot3(x_p,y_p,z_p,'Color',[0.8,0.8,0.8],'LineStyle','--','LineWidth',0.5,'Marker','o','MarkerSize',1.5);
