function [r_data_ref,basic_stats,add_stats]=kfd_multiv_orthogonal(data_ref,labels_ref,order,reg,...
    data_val,labels_val,balance_trajec_length,min_trajec_length,full_stats_disp)
%Kernel Fisher-Discriminant (Mika et al., 00). v4.0b. Discriminant subspace axes are ortogonalized.
%
...
% Lapish, C. and Balaguer-Ballester, E., Phillips, A, Seamans, J. and Durstewitz, D. 2015. Amphetamine Bidirectionally alters Prefrontal Cortex Attractor Dynamics during Working Memory. The Journal of Neuroscience 35(28): 10172-10187.
% Balaguer-Ballester E, Tabas-Diaz, A, Budka, M. 2014. Can we identify non-stationary dynamics of trial-to-trial variability? PLoS ONE. 
...
% Balaguer-Ballester E, Lapish C, Seamans JK and Durstewitz D. 2011 "Attracting Dynamics of Frontal Cortex Populations during Memory Guided Decision-Making". PLoS Comput. Biol
%
...
%  @ebb: orthogonal axes for visualization
...
%     end
    ...
    %That is why the file is named "orthogonal"
