function display_flow3(data,labels,trial_range,order,index_plot,no_flow_field)
%Auxiliary, private file, which displays up to four
...
%required
%19-Jun-2015 #several@ebb:new input argument for not dispalying the flow
%field
%
%__________________________________________________________________________
%
if nargin<5, no_flow_field=0; end
...
while count<n,
    if labels(count)==1
        ...
        if no_flow_field
            plot3(x,y,z,'Color',[0,0,.7],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[0,0,.7]);
            plot3(x,y,z,'Color',[.8,.8,1],'LineStyle','-','LineWidth',.1);
        end
    ...
    elseif labels(count)==2,
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color',[.1,.1,.1],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[.1,.1,.1]);
            plot3(x,y,z,'Color',[.8,.8,.8],'LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif (labels(count)==3)&&(n_labels>2),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color',[.6,.6,.6],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[.6,.6,.6]);
            plot3(x,y,z,'Color',[.9,.9,.9],'LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif (labels(count)==4)&&(n_labels>3),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color',[0,.7,0],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[0,.7,0]);
            plot3(x,y,z,'Color',[0.8,1,.8],'LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
        if flags(4),
            text(up_lim(1),low_lim(2)/2,up_lim(3)-3*step,'Epoch 4','Color',[0,.7,0],'FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==5)&&(n_labels>4),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color',[0.7,0,0],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[0.7,0,0]);
            plot3(x,y,z,'Color',[1,.8,.8],'LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif (labels(count)==6)&&(n_labels>5),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color',[.7,.7,0],'Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color',[.7,.7,0]);
            plot3(x,y,z,'Color',[1,1,.8],'LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif (labels(count)==7)&&(n_labels>6),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color','m','Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color','m');
            plot3(x,y,z,'Color','m','LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif (labels(count)==8)&&(n_labels>7),
        ...
        subplot(2,2,index_plot)
        if no_flow_field
            plot3(x,y,z,'Color','c','Marker','o','MarkerSize',1.5,'LineStyle','none');
        else
            quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                'Color','c');
            plot3(x,y,z,'Color','c','LineStyle','-','LineWidth',.1);
        end
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        x_d_prev=x_d(end);y_d_prev=y_d(end);z_d_prev=z_d(end);
        hold on
    ...
    elseif labels(count)==-1
        ...
        if all(labels(count:i,end-1)~=2),
            subplot(2,2,index_plot)
            if no_flow_field
                plot3(x,y,z,'Color',[.8,.8,.8],'Marker','o','MarkerSize',1.5,'LineStyle','none');
            else
                quiver3(x,y,z,x_d,y_d,z_d,scale,'Marker','o','MarkerSize',1.5,...
                    'Color',[0.8,0.8,0.8]);
                plot3(x,y,z,'Color',[.8,.8,.8],'LineStyle','-','LineWidth',.1);
