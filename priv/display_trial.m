...
%Private, auxiliary file. Plotting trajectory of a single trial. 
...
while count<n,
    if labels(count)==1
        ...
        plot3(x,y,z,'bo','LineStyle','-','LineWidth',1,'MarkerSize',1.5, 'Color',[0,0,.7]);
    ...
    elseif (labels(count)==2),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'ro','LineStyle','-','LineWidth',1,'MarkerSize',1.5, 'Color',[.7,0,0]);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
        if flags(2),
           title(['Expanded space of order ',num2str(order),' for trial #',num2str(trial)]),
    ...
    elseif (labels(count)==3)&&(n_labels>2),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'go','LineStyle','-','LineWidth',1,'MarkerSize',1.5, 'Color',[0,.7,0]);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
        if flags(3),
           title(['Expanded space of order ',num2str(order),' for trial #',num2str(trial)]),
    ...
    elseif (labels(count)==4)&&(n_labels>3),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'ko','LineStyle','-','LineWidth',1,'MarkerSize',1.5, 'Color',[.4,.4,.4]);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
        if flags(4),
           title(['Expanded space of order ',num2str(order),' for trial #',num2str(trial)]),
    ...
    elseif (labels(count)==5)&&(n_labels>4),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'yo','LineStyle','-','LineWidth',1,'MarkerSize',1.5,'Color',[.7,.7,0]);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
        if flags(5),
           title(['Expanded space of order ',num2str(order),' for trial #',num2str(trial)]),
    ...
    elseif (labels(count)==6)&&(n_labels>5),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'co','LineStyle','-','LineWidth',1,'MarkerSize',1.5);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
        if flags(6),
           title(['Expanded space of order ',num2str(order),' for trial #',num2str(trial)]),
    ...
    elseif (labels(count)==7)&&(n_labels>6),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'mo','LineStyle','-','LineWidth',1,'MarkerSize',1.5);%mo
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
    ...
    elseif (labels(count)==8)&&(n_labels>7),
        ...
        count=i;
        subplot(2,2,index_plot)
        plot3(x,y,z,'Color',[0.1,0.1,0.1],'LineStyle','-','LineWidth',1,'Marker','o',...
            'MarkerSize',1.5);
        x_prev=x(end);y_prev=y(end);z_prev=z(end);
        hold on
    ...
    elseif labels(count)==-1
        ...
        if all(labels(count:i,end-1)~=2),
         subplot(2,2,index_plot)  
         plot3(x,y,z,'Color',[0.8,0.8,0.8],'LineStyle','--','Marker','None',...
            'MarkerSize',1);     
        hold on
        end
        count=i;
